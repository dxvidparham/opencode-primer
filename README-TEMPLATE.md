...
[![Time Required](https://img.shields.io/badge/Time-45_min-orange)]()
[![Prerequisites](https://img.shields.io/badge/Prerequisites-Module_1-blue)]()
...
```mermaid
graph TD
    A[What You'll Learn] --> B[Key Concept 1]
    A --> C[Key Concept 2]
    A --> D[Key Concept 3]
...
```mermaid
flowchart TD
    A[Start Here] --> B[Run Quick Example]
    B --> C[Understand Output]
    C --> D[Modify Example]
    D --> E[Apply to Your Project]
```
...
```markdown
[![Completed Module](https://img.shields.io/badge/Completed-[Module_Name]-success)]()
```
...
[![OpenCode Primer](https://img.shields.io/badge/OpenCode_Primer-Module_[Number]-blue)](../README.md)
