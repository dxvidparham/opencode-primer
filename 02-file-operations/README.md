...
>
> 📂 **Hands-on companion:** [examples/file-exploration.md](examples/file-exploration.md) walks through file exploration prompts, shell equivalents, and practice exercises. Work through it alongside this module or use it as a reference.
